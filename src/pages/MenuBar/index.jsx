        ...
        <div className="flex bg-[black] w-full">
            <div className={`h-[100vh] pt-[50px] px-[24px] bg-[#fff] ${miniNav ? "w-[130px]":"w-[270px]"}`}>
                ...
                <div className="mt-[72px]">
                    ...
                    <div onClick={()=>setActiceMenu("HubBrowser")} 
                        className={`flex items-center cursor-pointer gap-[10px] px-[16px] py-[12px] bg-[#fff] rounded-[12px] text-[14px] font-medium text-[black] duration-300 mt-[20px] ${activeMenu === "HubBrowser" ? "pl-[40px]":""}`}>
                        <HubIcon/>
                        <p className={miniNav ? "hidden":""}>Hub Browser</p>
                    </div>
                    <div onClick={()=>setActiceMenu("AccAdministrator")} 
                        className={`flex items-center cursor-pointer gap-[10px] px-[16px] py-[12px] bg-[#fff] rounded-[12px] text-[14px] font-medium text-[black] duration-300 mt-[20px] ${activeMenu === "AccAdministrator" ? "pl-[40px]":""}`}>
                        <AdministratorIcon/>
                        <p className={miniNav ? "hidden":""}>Acc Administrator</p>
                    </div>
                    ...
                    <div onClick={()=>setActiceMenu("DesignAutomation")} 
                        className={`flex items-center cursor-pointer gap-[10px] px-[16px] py-[12px] bg-[#fff] rounded-[12px] text-[14px] font-medium text-[black] duration-300 mt-[20px] ${activeMenu === "DesignAutomation" ? "pl-[40px]":""}`}>
                        <DesignIcon/>
                        <p className={miniNav ? "hidden":""}>Design Automation</p>
                    </div>
                </div>
                <div className="mt-[87px]">
                    <div onClick={()=>setActiceMenu("Profile")} 
                        className={`flex items-center cursor-pointer gap-[10px] px-[16px] py-[12px] bg-[#fff] rounded-[12px] text-[14px] font-medium text-[black] duration-300 ${activeMenu === "Profile" ? "pl-[40px]":""}`}>
                        <ProfileIcon/>
                        <p className={miniNav ? "hidden":""}>Profile</p>
                    </div>
